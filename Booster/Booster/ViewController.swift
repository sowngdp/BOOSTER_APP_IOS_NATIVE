...
class ViewController: UIViewController, UIScrollViewDelegate {
    ...
    func createSlides() -> [Slides] {
        ...
        let slide2:Slides = Bundle.main.loadNibNamed("Slide", owner: self, options: nil)?.first as! Slides
        slide2.imageView.image = UIImage(named: "item_preview@2")
        slide2.labelTitle.text = "1Duplicate Apps: Call History, Notes, and more"

        
        let slide3:Slides = Bundle.main.loadNibNamed("Slides", owner: self, options: nil)?.first as! Slides
        slide3.imageView.image = UIImage(named: "item_preview@3")
